...
var TranslationsProvider = function (_a) {
    ...
    var _b = React.useState(getBrowserLanguage(translations, fallback)), _c = _b[0], languageTag = _c.languageTag, isRTL = _c.isRTL, setLanguage = _b[1];
    var handleLanguageChange = React.useCallback(function () {
    ...
    return (React__default['default'].createElement(TranslationsContext.Provider, { children: children, value: {
...
function useAvailableLanguages() {
    var t = React.useContext(TranslationsContext);
    return [
...
exports.useTranslationLanguage = useTranslationLanguage;
